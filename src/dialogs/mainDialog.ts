...
import { newclientDialog } from './NewClient/newclientDialog';
...
export class MainDialog extends ComponentDialog {
    ...
    constructor(luisRecognizer: FlightBookingRecognizer, bookingDialog: BookingDialog,NewClientDialog: newclientDialog) {
        super('MainDialog');
