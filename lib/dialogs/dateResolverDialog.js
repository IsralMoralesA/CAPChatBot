...
exports.DateResolverDialog = void 0;
...
class DateResolverDialog extends cancelAndHelpDialog_1.CancelAndHelpDialog {
    ...
    initialStep(stepContext) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const promptMessage = botbuilder_1.MessageFactory.text(promptMessageText, promptMessageText, botbuilder_1.InputHints.ExpectingInput);
            const repromptMessageText = 'I\'m sorry, for best results, please enter your travel date including the month, day and year.';
            const repromptMessage = botbuilder_1.MessageFactory.text(repromptMessageText, repromptMessageText, botbuilder_1.InputHints.ExpectingInput);
            if (!timex) {
            ...
            if (!timexProperty.types.has('definite')) {
                ...
                return yield stepContext.prompt(DATETIME_PROMPT, { prompt: repromptMessage });
            }
