...
const bookingDialog_1 = require("./dialogs/Booking/bookingDialog");
...
const flightBookingRecognizer_1 = require("./dialogs/Booking/flightBookingRecognizer");
// The helper-class recognizer that calls LUIS
...
luisRecognizer = new flightBookingRecognizer_1.FlightBookingRecognizer(luisConfig);
// Create the main dialog.
const bookingDialog = new bookingDialog_1.BookingDialog(BOOKING_DIALOG);
const dialog = new mainDialog_1.MainDialog(luisRecognizer, bookingDialog);
